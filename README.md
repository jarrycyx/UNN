...
| CausalTime  | A novel pipeline capable of generating realistic time-series along with a ground truth causal graph that is generalizable to different fields. | [arXiv](https://arxiv.org/abs/XXX) | [Code🧑‍💻](CausalTime/) ｜ [Official Website](https://www.causaltime.cc/)
